...
from gate_presentation_regression import evaluate, SHIPPING, FRAMES, SEQUENCES
...
class PresentationGateTests(unittest.TestCase):
    def setUp(self):
        ...
        self.manifest = dict(copy.deepcopy(self.report), source_manifest_sha256=SEQUENCES,
                             ...
                             presentation_corpus='regression960', preserve_display_gain=True)
        self.config = dict(candidate_sha256=SHIPPING, radius=2,
                           preserve_display_gain=True, frames_manifest_sha256=FRAMES)
