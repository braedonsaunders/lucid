...
Set-Location 'C:\lucid\quality-breakthrough-20260908-r40'
...
try {
 ...
 $env:PYTHONPATH='C:\lucid\quality-breakthrough-20260908-r40\Tools;C:\lucid\quality-breakthrough-20260908-r40\Tools\experiments;C:\lucid\frontier-eval-deps-20260904;C:\lucid\pixrestore-baseline-20260904\deps'
 ...
 # Matched 1k precision ablation from big2k; losses and critic arithmetic unchanged.
 foreach($arm in @('big_bf16_control_1k','big_fp32_sr_1k')){
  $arguments=$base+@('--out',$arm)
  if($arm -eq 'big_fp32_sr_1k'){$arguments+=@('--sr-precision','fp32')}
