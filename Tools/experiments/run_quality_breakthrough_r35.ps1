...
Set-Location 'C:\lucid\quality-breakthrough-20260908-r35'
...
try {
 ...
 # Combined input/output follow-up; reuses the matched r33 control.
 foreach($arm in @('big_full_stages_1k')){
  $arguments=$base+@('--out',$arm)
  $arguments+=@('--native-input-stages','--native-output-stages')
