...
Set-Location 'C:\lucid\quality-breakthrough-20260908-r38'
...
try {
 $env:PYTHONPATH='C:\lucid\quality-breakthrough-20260908-r38\Tools;C:\lucid\quality-breakthrough-20260908-r38\Tools\experiments;C:\lucid\frontier-eval-deps-20260904;C:\lucid\pixrestore-baseline-20260904\deps'
 Run-Python 'mapped-unit-tests' @('-m','unittest','discover','-s','Tools/experiments','-p','test_mmap_training_bank.py')
 $base=@('-u','Tools/experiments/train_presented_detail.py','--bank','D:\lucid-quality-breakthrough-r37\v4-mapped','--pixrestore-cache','none','--shipping-cache','none','--crop','96','--seed','20260918','--teacher-mix','0','--intended','reference','--architecture','coupled','--detail-target','reference')
