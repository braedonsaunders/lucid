...
## PLKSR-Rep author release

The author subsequently located for our evaluation provides a runnable [CVPR Workshops 2026 release](https://github.com/Innocentlove321/ntire2026-mobile-realworld-sr-vipsl19), pinned at `ef4442ca57d7037593a1e608be294c351d0dc3d9`. Its original FP32 graph improves LPIPS by 15.36% on the frozen development comparison but worsens DISTS by 7.29% and violates fine-detail limits on all three sources. The valid FP32 Core ML export takes 296.90 ms mean / 297.54 ms p95 at 360p→1440p; both tested FP16 compute configurations fail our RGB precision limits. These measurements reject it as a native replacement here. They do not rank its broader image-restoration capability. See `plksr-rep-protocol.md`, raw quality reports and native profiles for pinned weights, padding, common presentation, unchanged gates and limitations.
