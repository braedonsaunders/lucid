...
if((Get-FileHash 'probe.json').Hash -ne '1fbfface8ca3189f1dcb8875f9373d3853e41b4541a0e4e6f4e932252dd63ef5' -or (Get-FileHash 'native-profile.json').Hash -ne '8140340f50650bc7b53c922620e06d9e65a32426611a95981cf2f116ae248d59'){throw 'Changed frozen preflight'}
