...
Set-Location 'C:\lucid\causal-pixrestore-distill-20260904'
...
foreach ($path in @('teacher-cache', 'distilled', 'control', 'owner.lock')) {
...
try {
    ...
    Run-Python 'teacher' @('-u', 'Tools/experiments/cache_pixrestore_teacher.py', '--bank', 'bank', '--out', 'teacher-cache', '--repository', 'C:\lucid\pixrestore-baseline-20260904', '--provenance', 'teacher-provenance.json', '--checkpoint', 'C:\lucid\frontier-teachers-20260904\pixrestore-s', '--dino-repository', 'C:\lucid\causal-frontier-20260904-dino\third_party\dinov2', '--dino-checkpoint', 'C:\lucid\frontier-teachers-20260904\dinov2_vits14_pretrain.pth', '--seed', '20260913')
    $shared = @('-u', 'Tools/experiments/train_causal_detail.py', '--architecture', 'causal_detail_v2', '--bank', 'bank', '--steps', '4000', '--channels', '32', '--blocks', '4', '--batch', '4', '--crop', '96', '--lr', '0.0001', '--seed', '20260913', '--device', 'cuda', '--precision', 'bf16', '--dino-weight', '0.03', '--dino-repository', 'C:\lucid\causal-frontier-20260904-dino\third_party\dinov2', '--dino-checkpoint', 'C:\lucid\frontier-teachers-20260904\dinov2_vits14_pretrain.pth', '--init', 'C:\lucid\causal-capacity-20260904\control-recovery\step008000.pth', '--teacher-cache', 'teacher-cache')
    Run-Python 'distilled' ($shared + @('--teacher-weight', '1', '--out', 'distilled'))
    Run-Python 'control' ($shared + @('--teacher-weight', '0', '--out', 'control'))
