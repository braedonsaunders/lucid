...
Set-Location 'C:\lucid\local-fidelity-20260905-r3'
...
try {
    ...
    & C:\lucid\.venv\Scripts\python.exe Tools/experiments/check_deterministic_resize_cuda.py
    if($LASTEXITCODE -ne 0){throw 'Deterministic resize preflight failed'}
