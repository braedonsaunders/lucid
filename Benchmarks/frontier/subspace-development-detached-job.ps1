...
foreach($label in @('full','protected')){
...
try {
 ...
 $arguments=@('-u','Tools/frontier_eval/score_checkpoint_frames.py','--device','cuda','--frames',$frames,'--checkpoint','protected','protected/step008000.pth','--checkpoint','full','full/step008000.pth','--checkpoint','shipping','C:\lucid\presented-detail-20260904\shipping.pth','--present-4x-at-2x','shipping','--report',"$Mode.json")
