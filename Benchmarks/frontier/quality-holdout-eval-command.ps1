...
Set-Location 'C:\lucid\quality-holdout-frozen-20260905'
...
try {
    ...
    $arguments = @('-u', 'Tools/frontier_eval/score_checkpoint_frames.py', '--device', 'cuda', '--frames', 'frames', '--checkpoint', 'blend80', 'blend-0.8.pth', '--checkpoint', 'shipping', 'C:\lucid\presented-detail-20260904\shipping.pth', '--present-4x-at-2x', 'shipping', '--report', 'evaluation.json')
