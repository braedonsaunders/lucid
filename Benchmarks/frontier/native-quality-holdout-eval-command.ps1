...
Set-Location 'C:\lucid\native-quality-holdout-20260905'
...
try {
    ...
    $arguments = @('-u', 'Tools/frontier_eval/score_native_holdout.py', '--device', 'cuda', '--frames', 'frames', '--references', 'C:\lucid\quality-holdout-frozen-20260905\frames', '--report', 'evaluation.json')
